...
/* harmony import */ var _modules_deviceType__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/deviceType */ "./src/js/modules/deviceType.js");
/* harmony import */ var _modules_headerModule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/headerModule */ "./src/js/modules/headerModule.js");


          window.addEventListener('DOMContentLoaded', function () {
            Object(_modules_deviceType__WEBPACK_IMPORTED_MODULE_0__["default"])();
            Object(_modules_headerModule__WEBPACK_IMPORTED_MODULE_1__["default"])();
          });

          /***/
        }),

/***/ "./src/js/modules/deviceType.js":
/*!**************************************!*\
  !*** ./src/js/modules/deviceType.js ***!
  \**************************************/
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
          ...
          "use strict";
          __webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function () { return deviceType; });
          function deviceType() {
...
/* harmony import */ var _headerNavigation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./headerNavigation */ "./src/js/modules/headerNavigation.js");

          function headerModule() {
            var header = document.querySelector('#header');
            var headerHeight = header.offsetHeight;
            document.querySelector('main').style.paddingTop = "".concat(headerHeight, "px");
            Object(_headerNavigation__WEBPACK_IMPORTED_MODULE_0__["default"])();
          }

          /***/
        }),

/***/ "./src/js/modules/headerNavigation.js":
/*!********************************************!*\
  !*** ./src/js/modules/headerNavigation.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function () { return headerNavigation; });
          function headerNavigation() {
            var navigationContainer = document.querySelector('.header-main .container');
            var headerNavList = document.querySelector('#main-nav ul');
            var navListYet = document.querySelector('.main-nav_yet');
            var navSublistYet = document.querySelector('.main-nav_yet-sublist');
            var logo = document.querySelector('.header-main__logo');
            ...
            function hideNavigationElements() {
              ...
              if (nav) {
                if (headerNavList.offsetWidth + navListYet.offsetWidth + logo.offsetWidth + 75 > navigationContainer.offsetWidth && navList.querySelector('li')) {
                  navListYet.classList.remove('hide');
                  navListYet.classList.add('show');

                  while (headerNavList.offsetWidth + navListYet.offsetWidth + logo.offsetWidth + 75 > navigationContainer.offsetWidth && navList.querySelector('li')) {
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
          ...
          swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Keyboard"], swiper__WEBPACK_IMPORTED_MODULE_0__["Mousewheel"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_0__["Parallax"]]);
          window.addEventListener('DOMContentLoaded', function () {
            // eslint-disable-next-line
            var scrollingSection = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.scrolling-section-slider', {
              grabCursor: true,
              speed: 800,
              parallax: true,
              mousewheel: true,
              ...
              pagination: {
                ...
                renderProgressbar: function renderProgressbar(progressbarFillClass) {
                  return "\n          <div class=\"".concat(progressbarFillClass, "\"></div>\n          <div id=\"timeline-controls\"></div>\n          <div id=\"timeline\"></div>\n        ");
                }
              },
              on: {
                // eslint-disable-next-line
                afterInit: function afterInit(swiper) {
                  ...
                  for (var index = 0; index < swiper.slides.length; index++) {
                    ...
                    var _timelineControls = document.querySelector('#timeline-controls');

                    var bullet = document.createElement('div');
                    bullet.className = 'timeline-bullet';
                    var dateHTML = swiper.slides[index].querySelector('.section-slider-item__date .date').innerHTML;
                    var dateClass = '';
                    var dateContent = '';
                    ...
                    if (dateHTML === '') {
                      ...
                      dateClass = 'with-date';
                      dateContent = "\n              ".concat(swiper.slides[index].querySelector('.section-slider-item__date .date').innerHTML.substr(0, 3), ".");
                    }

                    bullet.innerHTML = "\n            <div class=\"full-date\">\n              <span class=\"".concat(dateClass, "\">").concat(dateContent, "</span>\n              <span class=\"year\">").concat(swiper.slides[index].querySelector('.section-slider-item__date .year').innerHTML, "</span>\n            </div>\n            <div class=\"title\">").concat(swiper.slides[index].querySelector('.section-slider-item__title').innerHTML, "</div>\n          ");

                    _timelineControls.append(bullet);
                  }
                }
              }
            });
            var timelineBullets = document.querySelectorAll('.timeline-bullet');
            timelineBullets[0].classList.add('active');
            timelineBullets.forEach(function (elem, index) {
              elem.addEventListener('click', function () {
                scrollingSection.slideTo(index);
              });
            });
            scrollingSection.on('activeIndexChange', function () {
              timelineBullets.forEach(function (bullet) {
                bullet.classList.remove('active');
                timelineBullets[scrollingSection.activeIndex].classList.add('active');
              });
            });
            var pointWidth = document.querySelector('.timeline-point').offsetWidth;
            var timelineControls = document.querySelector('#timeline-controls');
            timelineControls.style.transform = "translateX(".concat(pointWidth / 2, "px)");

            if (document.body.offsetWidth <= 1024) {
              scrollingSection.destroy();
            }
